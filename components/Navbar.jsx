...
const Navbar = () =>
{
    ...
    return (
        <nav className="font-mono bg-gray-900 border-gray-200 px-2 sm:px-4 py-2.5 rounded-lg">
            <div className="container flex flex-wrap items-center justify-between mx-auto">
                ...
                <div className={menuClasses} id="navbar-default">
                    <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-xl md:font-medium md:border-0 md:bg-gray-900">
